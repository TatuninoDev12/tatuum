            ...
            <Sheet>
                ...
                <SheetContent side='left' className='border-none bg-dark-1'>
                    <Link href='/' className='flex items-center gap-1'>
                        <Image src='/icons/logo.svg' width={32} height={32} alt='Tatuum Logo' className='max-sm:size-10' />
                        <p className='text-[26px] font-extrabold max-sm:hidden text-white'>Tatuum</p>
                    </Link>
